...
int main() {
  ...
  //   // KITTI camera configuration with focal length scaled for model
  //   resolution float baseline = 0.53716f;  // KITTI baseline in meters float
  //   kitti_focal_length =
  //       721.5377f;  // KITTI focal length for 1242x375 images
  //   // float scaled_focal_length = kitti_focal_length *
  //   model_resolution.width /
  ...
  //   +
  //   //                         std::to_string(model_resolution.width) +
  ...
  //   std::cout << "Loading StereoDepth model from: " << model_path <<
  //   std::endl; std::cout << "Model resolution: " << model_resolution.width <<
  //   "x"
  //             << model_resolution.height << std::endl;
  //   // std::cout << "Scaled focal length: " << scaled_focal_length << "
  //   pixels"
  //   // << std::endl;
  ...
  //     // depth_estimator.get_disparity_map(true);   // Original image
  //     resolution
  //     // cv::Mat original_depth = depth_estimator.get_depth_map(true); //
  //     // Original image resolution

  //     // std::cout << "Model resolution disparity: " <<
  //     model_disparity.size()
  //     // << std::endl; std::cout << "Original resolution disparity: " <<
  //     // original_disparity.size() << std::endl;

  //     // Create visualizations (these are automatically at original
  //     resolution)
  ...
  //     // std::cout << "- kitti_depth_overlay.png (visualization)" <<
  //     std::endl;
